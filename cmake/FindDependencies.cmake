...
set(hip_FOUND OFF)
if(HIP_ENABLED)
    message(STATUS "Looking for HIP...")
    
    find_package(hip CONFIG QUIET)
    if(hip_FOUND)
        message(STATUS "Found HIP version ${HIP_VERSION} installed")
        enable_language(HIP)
        set(hip_FOUND ON)
        find_package(hiprand CONFIG QUIET)
        if(NOT hiprand_FOUND)
            message(WARNING "Disabling HIP support (hiprand not found)")
            set(hip_FOUND OFF)
        endif()
    else()
        message(WARNING "Disabling HIP support (not found). Consider set CMAKE_PREFIX_PATH=/path/to/rocm")
    endif()
else()
    message(STATUS "Disabling HIP support")
endif()

if(HIP_ENABLED AND hip_FOUND)
